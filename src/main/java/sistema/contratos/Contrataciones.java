...
import sistema.asignaciones.RondaAsignaciones;
...
public class Contrataciones {
    ...
    public void write() throws IOException {
        Persistencia.write("rondaDeElecciones.ser", rondaDeElecciones);
        Persistencia.write("rondaDeContratacion.ser", rondaDeContratacion);

    }

    public void read() throws IOException, ClassNotFoundException {
        rondaDeElecciones = (RondaDeElecciones) Persistencia.read("rondaDeElecciones.ser");
        rondaDeContratacion = (RondaDeContratacion) Persistencia.read("rondaDeContratacion.ser");
    }
    /**
